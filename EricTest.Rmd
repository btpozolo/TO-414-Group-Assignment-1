...
```
Penn Station Valet station has the most deficit flow in the year,
...
```
For January 2016, we noticed that the stations with the most unbalanced flow are clustering around the Lincoln Tunnel in the Manhattan borough. 
...
```
On the weekend, the stations with top deficit flow are clustering around the south of the Central Park, 
while on the weekday, the stations with both the top deficit and surplus are clustering around the Lincoln Tunnel in the Manhattan borough. 
