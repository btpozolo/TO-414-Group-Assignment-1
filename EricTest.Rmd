...
```
##Stations with top surplus and deficit for the whole 2016 as shown on the map
```{r}
...
##Stations with top deficit and surplus for each month of the year 2016 as shown on the map
```{r}
...
```
##Stations with top deficit and surplus for the weekend versus weekday as shown on the map
```{r}
